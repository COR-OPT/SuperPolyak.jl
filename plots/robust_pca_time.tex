...
\begin{tikzpicture}% table
  \begin{axis}[xlabel={Time (s)},ylabel=$f(x_k)$, ymode=log,
         ...
         legend entries={{$\alpha = 0.1$}, {$\alpha = 0.2$}, {$\alpha = 0.3$}, {$\alpha = 0.4$},
                         {\texttt{SuperPolyak}},
                         {Alt. Projections}}]
  ...
  \addlegendimage{mark=diamond*, very thick, color=black};
  ...
  \addplot[mark=diamond*, very thick, color=black] table[x=cumul_elapsed_time,y=fvals, col sep=comma]
    {./robust_pca_200_200_50_p-0.4_bundle.csv};
  \addplot[no markers, very thick, dashed, color=black] table[x=cumul_elapsed_time,y=fvals, col sep=comma]
    {./robust_pca_200_200_50_p-0.4_vanilla.csv};
	\end{axis}
\end{tikzpicture}
\end{document}
