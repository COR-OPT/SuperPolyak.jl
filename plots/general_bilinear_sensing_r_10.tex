...
% Expected filename: `general_bilinear_sensing_$(m)_$(d)_$(r)_{bundle,polyak.csv}`, where:
%   1) $(m) is number of measurements;
%   2) $(d) and $(r)$ are the number of rows and columns of the unknown signals;
...
\begin{tikzpicture}% table
    \begin{axis}[xlabel={Cumulative oracle calls},ylabel=$f(x_k)$, ymode=log,
				 enlargelimits=false, ymin=1e-16, ymax=1.1,
