...
\begin{tikzpicture}% table
    \begin{axis}[xlabel={Cumulative oracle calls},ylabel=$f(x_k)$, ymode=log,
         ...
         title={\textbf{Quadratic sensing} ($r=2$)},
