...
\begin{tikzpicture}% table
  ...
  \addplot[mark=diamond*, very thick, color=black] table[x=cumul_oracle_calls,y=fvals, col sep=comma]
    {./robust_pca_200_200_50_p-0.4_bundle.csv};
  \addplot[no markers, very thick, dashed, color=black] table[x=cumul_oracle_calls,y=fvals, col sep=comma]
